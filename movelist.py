...
class Moves:
    def __init__(self):
        ...
        self.steelmoves=["Flash Cannon","Meteor Mash","Bullet Punch","Steel Beam","Doom Desire","Gyro Ball","Heavy Slam","Iron Head","Iron Tail","Steel Wing","Corkscrew Crash","Sunsteel Strike","Max Steelspike","Behemoth Bash","Behemoth Blade","Searing Sunraze Smash","G-Max Steelsurge","Make It Rain","Double Iron Bash","Gigaton Hammer","Spin Out","G-Max Meltdown","Gear Grind","Anchor Shot","Smart Strike","Metal Burst","Autotomize","Gear Up","Iron Defense","Kings Shield","Metal Sound","Shelter","Shift Gear","Tachyon Cutter"]
