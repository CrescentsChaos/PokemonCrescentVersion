...
class Moves:
    def __init__(self):
        ...
        self.multimove=["Bullet Seed","Rock Blast","Pin Missile","Icicle Spear","Dual Chop","Dual Wingbeat","Arm Thrust","Water Shuriken","Double Iron Bash","Spike Cannon","Triple Axel","Triple Arrows","Triple Kick","Population Bomb","Scale Shot","Double Hit","Bonemerang"]
