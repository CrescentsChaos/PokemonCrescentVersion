...
class Moves:
    def __init__(self):
        ...
        self.bugmoves=["Megahorn","Pin Missile","Bug Buzz","U-turn","X-Scissor","Leech Life","Savage Spin-Out","Max Flutterby","G-Max Befuddle","Pounce","Lunge","First Impression","Skitter Smack","Signal Beam","Attack Order","Pollen Puff","Infestation","Fell Stinger"]
        ...
        self.steelmoves=["Flash Cannon","Meteor Mash","Bullet Punch","Steel Beam","Doom Desire","Gyro Ball","Heavy Slam","Iron Head","Iron Tail","Steel Wing","Corkscrew Crash","Sunsteel Strike","Max Steelspike","Behemoth Bash","Behemoth Blade","Searing Sunraze Smash","G-Max Steelsurge","Make It Rain","Double Iron Bash","Gigaton Hammer","Spin Out","G-Max Meltdown","Gear Grind","Anchor Shot","Smart Strike","Metal Burst"]
