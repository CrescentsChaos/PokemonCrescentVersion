...
async def weakness(ctx,x,y,field,em):
    ...
    if x.use in typemoves.contactmoves:
        if x.ability in ["Tough Claws","Big Pecks"] and "Neutralizing Gas" not in y.ability:
            em.add_field(name=f"{x.icon} {x.nickname}'s {x.ability}!",value="Contact move was boosted!")
            eff*=1.33
        elif x.ability=="Speed Force" and "Neutralizing Gas" not in y.ability:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Contact move was boosted!")
            if (x.speed/x.atk)>1.5:
                eff*=1.5
            else:
                eff*=(x.speed/x.atk) 
    if x.use in typemoves.soundmoves and x.ability=="Punk Rock" and "Neutralizing Gas" not in y.ability:
        em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Sound move was boosted!")
        eff*=1.3
    if x.use in typemoves.soundmoves and y.ability=="Punk Rock" and "Neutralizing Gas" not in x.ability:
        em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Sound move was reduced!")
        eff*=0.5
    if x.charged==True:
    ...
    if x.use in typemoves.windmoves and y.ability=="Wind Rider" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"]:
        ...
        em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Wind move was boosted!")
    ...
    #Color Change
    elif x.ability in ["Color Change"] and x.primaryType!=y.atktype and "Neutralizing Gas" not in y.ability:
        x.secondaryType="None"
        x.primaryType=y.atktype
        em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value=f"{x.name} changed it's type to {x.primaryType}!")
    ...
    #SOLAR POWER
        ...
        em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value=f"Damage boosted in sunlight!")
        eff*=1.5
    #ANALYTIC
    elif x.ability=="Analytic" and "Neutralizing Gas" not in y.ability:
        if x.speed<y.speed:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value=f"Damage boosted for moving slow!")
            eff*=1.3
    #NORMALIZE 
    ...
    if x.atktype=="Ghost":
        ...
        if y.item=="Kasib Berry" and x.ability not in ["Unnerve","As One"]:
            em.add_field(name=f"{y.icon} {y.nickname}'s {await itemicon(y.item)} {y.item}!",value=f"{y.name}'s {y.item} weakened the damage of {x.atktype}-type move!")
            y.item+="[Used]"
        #Ghost Gem
        if x.item == "Ghost Gem":
            eff*=1.5
            ...
            x.item+="[Used]"
        if x.item in ["Griseous Orb","Spooky Plate","Spell Tag"]:
            eff*=1.2
        if y.primaryType in ghosteff and y.teraType=="???":
            ty*=2
        if y.secondaryType in ghosteff and y.teraType=="???":
            ty*=2
        if y.teraType in ghosteff:
            ty*=2
        if y.primaryType in ghostwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in ghostwk and y.teraType=="???":
            ty/=2
        if y.teraType in ghostwk:
            ty/=2
        if ((y.primaryType in ghostimmune or y.secondaryType in ghostimmune) and y.teraType=="???") or (y.teraType in ghostimmune and y.item!="Ring Target"):
            ty*=0         
    ...
    if x.atktype=="Electric":
        ...
        if y.ability=="Wonder Guard" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value=f"{y.nickname} is immune to {x.atktype}-Type move!")
            eff*=0
        #Transistor
        ...
        if x.item == "Electric Gem":
            eff*=1.5
            em.add_field(name=f"{x.icon} {x.nickname}'s {await itemicon(x.item)} {x.item}!",value=f"{x.item} strengthened the damage of {x.icon} {x.nickname}'s {x.atktype}-type moves!")
            x.item+="[Used]"
        ...
        if y.ability=="Volt Absorb" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            if y.hp>y.maxhp-(y.maxhp/4):
                y.hp=y.maxhp
            eff*=0
        if y.primaryType in electriceff and y.teraType=="???":
            ty*=2
        if y.teraType in electriceff:
            ty*=2
        if y.secondaryType in electriceff and y.teraType=="???":
            ty*=2
        if y.primaryType in electricwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in electricwk and y.teraType=="???":
            ty/=2
        if y.teraType in electricwk:
            ty/=2
        if (y.primaryType in electricimmune or y.secondaryType in electricimmune and y.teraType=="???") or y.teraType in electricimmune and y.item!="Ring Target":
            ty*=0
    ...
    if x.atktype=="Psychic":
        if y.ability=="Dark Mind" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            eff*=0
        if y.ability=="Wonder Guard" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value=f"{y.nickname} is immune to {x.atktype}-Type attack!")
            eff*=0
        ...
        if y.primaryType in psychiceff and y.teraType=="???":
            ty*=2
        if y.secondaryType in psychiceff and y.teraType=="???":
            ty*=2
        if y.primaryType in psychicwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in psychicwk and y.teraType=="???":
            ty/=2
        if y.teraType in psychiceff:
            ty*=2
        if y.teraType in psychicwk:
            ty/=2
        if (y.primaryType in psychicimmune or y.secondaryType in psychicimmune and y.teraType=="???") or y.teraType in psychicimmune and y.item!="Ring Target":
            ty*=0
    #ice
    if x.atktype=="Ice":
        if x.ability=="Icy Aura" and "Neutralizing Gas" not in y.ability:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Icy move was boosted!")
            eff*=1.5
        ...
        if y.ability=="Thick Fat" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Ice move was resisted!")
            eff*=0.5
        ...
        if y.primaryType in iceeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in iceeff and y.teraType=="???":
            ty*=2
        if y.primaryType in icewk and y.teraType=="???":
            ty/=2
        if y.secondaryType in icewk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Fairy":
        ...
        if y.primaryType in fairyeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in fairyeff and y.teraType=="???":
            ty*=2
        if y.primaryType in fairywk and y.teraType=="???":
            ty/=2
        if y.secondaryType in fairywk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Dark":
        ...
        if y.secondaryType in darkeff and y.teraType=="???":
            ty*=2
        if y.primaryType in darkwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in darkwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Steel":
        ...
        if x.ability=="Steelworker":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Steel move was boosted!")
            eff*=1.5
        if x.item == "Steel Gem":
            eff*=1.5
            em.add_field(name=f"{x.icon} {x.nickname}'s {await itemicon(x.item)} {x.item}!",value=f"{x.item} strengthened the damage of {x.icon} {x.nickname}'s {x.atktype}-type moves!")
        ...
        if x.item in ["Adamant Orb"]:
            eff+=(eff*0.2)
        if y.primaryType in steeleff and y.teraType=="???":
            ty*=2
        if y.secondaryType in steeleff and y.teraType=="???":
            ty*=2
        if y.primaryType in steelwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in steelwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Dragon":
        ...
        if x.ability=="Dragon's Maw":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Dragon move was boosted!")
            eff*=1.5
        ...
        if x.item in ["Adamant Orb","Lustrous Orb","Griseous Orb","Soul Dew"]:
            eff*=1.2
        if y.primaryType in dragoneff and y.teraType=="???":
            ty*=2
        if y.secondaryType in dragoneff and y.teraType=="???":
            ty*=2
        if y.primaryType in dragonwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in dragonwk and y.teraType=="???":
            ty/=2
        if y.teraType in dragoneff:
            ty*=2
        if y.teraType in dragonwk:
            ty/=2
        if (y.primaryType in dragonimmune or y.secondaryType in dragonimmune and y.teraType=="???") or y.teraType in dragonimmune and y.item!="Ring Target":
            ty*=0
    #bug
    if x.atktype=="Bug":
        if y.ability=="Rattled":
        ...
        if x.ability=="Swarm" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            if x.hp<=(x.maxhp/3):
                em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Bug move was boosted!")
                eff*=1.5
        if y.primaryType in bugeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in bugeff and y.teraType=="???":
            ty*=2
        if y.primaryType in bugwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in bugwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Water":
        if x.ability=="Water Bubble":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Water move was boosted!")
            eff*=2
        ...
        if x.ability=="Torrent" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            if x.hp<=(x.maxhp/3):
                ...
                eff*=1.2
        if y.primaryType in watereff and y.teraType=="???":
            ty*=2
        if y.secondaryType in watereff and y.teraType=="???":
            ty*=2
        if y.primaryType in waterwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in waterwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Ground":
        ...
        if (y.ability in ["Levitate","Winged"] and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves and x.grav is not True):
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value=f"{y.nickname} is levitating on the air and immune to Ground attacks!")
            eff*=0
        if y.primaryType in groundeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in groundeff and y.teraType=="???":
            ty*=2
        if y.primaryType in groundwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in groundwk and y.teraType=="???":
            ty/=2
        if y.teraType in groundeff:
            ty*=2
        if y.teraType in groundwk:
            ty/=2
        if (y.primaryType in groundimmune or y.secondaryType in groundimmune and y.teraType=="???") or y.teraType in groundimmune and y.item!="Ring Target" and x.grav==False and x.ability!="Ground Shock":
            if y.item!="Iron Ball":
                ty*=0
    #GRASS
    if x.atktype=="Grass":
        ...
        if x.ability=="Overgrow":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Grass move was boosted!")
            if x.hp<=(x.maxhp/3):
                eff*=1.5
            else:
                eff*=1.2
        if y.primaryType in grasseff and y.teraType=="???":
            ty*=2
        if y.secondaryType in grasseff and y.teraType=="???":
            ty*=2
        if y.primaryType in grasswk and y.teraType=="???":
            ty/=2
        if y.secondaryType in grasswk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Flying":
        if x.ability=="Flock" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Flying move was boosted!")
            if x.hp<=(x.maxhp/3):
                eff*=1.5
            else:
                eff*=1.2
        ...
        if y.primaryType in flyingeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in flyingeff and y.teraType=="???":
            ty*=2
        if y.primaryType in flyingwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in flyingwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Fire":
        ...
        if x.ability=="Radiant Blaze" or x.flashfire==True:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Fire move was boosted!")
            eff*=1.5
        ...
        if y.ability=="Fluffy" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Fire is burning its fur armor!")
            eff*=2
        if y.ability=="Steam Engine" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
        ...
        if y.ability=="Water Bubble":
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Fire move was weakened!")
            eff*=0.5
        ...
        if y.ability=="Dry Skin" and "Cloud Nine" not in (x.ability,y.ability):
            ...
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Fire move was resisted!")
            eff*=0.5
        ...
        if y.ability=="Flash Fire" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            y.flashfire=True
            eff*=0
        if y.primaryType in fireeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in fireeff and y.teraType=="???":
            ty*=2
        if y.primaryType in firewk and y.teraType=="???":
            ty/=2
        if y.secondaryType in firewk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Poison":
        if x.ability in ["Venomous Aura"]:
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Poison move was boosted!")
            eff*=1.5
        if y.ability=="Wonder Guard" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value=f"{y.nickname} is immune to {x.atktype}-Type attack!")
            eff*=0
        ...
        if y.primaryType in poisoneff and y.teraType=="???":
            ty*=2
        if y.secondaryType in poisoneff and y.teraType=="???":
            ty*=2
        if y.primaryType in poisonwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in poisonwk and y.teraType=="???":
            ty/=2
        if y.teraType in poisoneff:
            ty*=2
        if y.teraType in poisonwk:
            ty/=2
        if (y.primaryType in poisonimmune or y.secondaryType in poisonimmune and y.teraType=="???") or y.teraType in poisonimmune and y.item!="Ring Target":
    ...
    if x.atktype=="Rock":
        ...
        if y.ability=="Mountaineer" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            eff*=0
        if x.ability=="Sand Force" and field.weather=="Sandstorm":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Rock move was boosted!")
            eff*=1.3
        ...
        if y.ability=="Delta Stream" and "Flying" in (y.primaryType,y.secondaryType) and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            ...
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Rock move was resisted!")
            eff*=0.5
        if x.item == "Rock Gem":
            eff*=1.5
            em.add_field(name=f"{x.icon} {x.nickname}'s {await itemicon(x.item)} {x.item}!",value=f"{x.item} strengthened the damage of {x.icon} {x.nickname}'s {x.atktype}-type moves!")
        ...
        if y.primaryType in rockeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in rockeff and y.teraType=="???":
            ty*=2
        if y.primaryType in rockwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in rockwk and y.teraType=="???":
            ty/=2
    ...
    if x.atktype=="Normal":
        if x.ability=="Talon Sweep":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Normal move was boosted!")
            eff*=1.5
        if y.ability=="Wonder Guard" and x.ability not in ["Mold Breaker","Teravolt","Turboblaze","Propeller Tail","Stalwart","Neutralizing Gas"] and x.use not in typemoves.abilityigmoves:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value=f"{y.nickname} is immune to {x.atktype}-Type attack!")
            eff*=0
        ...
        if y.primaryType in normaleff and y.teraType=="???":
            ty*=2
        if y.secondaryType in normaleff and y.teraType=="???":
            ty*=2
        if y.primaryType in normalwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in normalwk and y.teraType=="???":
            ty/=2
        if y.teraType in normaleff:
            ty*=2
        if y.teraType in normalwk:
            ty/=2
        if ((y.primaryType in normalimmune or y.secondaryType in normalimmune) and y.teraType=="???") or (y.teraType in normalimmune and y.item!="Ring Target"):
    ...
    if x.atktype=="Fighting":
        ...
        if y.primaryType in fightingeff and y.teraType=="???":
            ty*=2
        if y.secondaryType in fightingeff and y.teraType=="???":
            ty*=2
        if y.primaryType in fightingwk and y.teraType=="???":
            ty/=2
        if y.secondaryType in fightingwk and y.teraType=="???":
            ty/=2
        if y.teraType in fightingeff:
            ty*=2
        if y.teraType in fightingwk:
            ty/=2
        if (y.primaryType in fightingimmune or y.secondaryType in fightingimmune and y.teraType=="???") or y.teraType in fightingimmune and y.item!="Ring Target":
            ty*=0     
    if y.hp!=0:
    ...
    if ty>=2 and eff!=0:
        ...
        if x.ability=="Fatal Precision":
            em.add_field(name=f"{x.icon} {x.name}'s {x.ability}!",value="Super effective move was boosted!")
            eff*=1.2
        if y.item=="Enigma Berry" and x.ability not in ["Unnerve","As One"]:
            y.hp+=round(y.maxhp/4)
            y.item+="[Used]"
        if y.item=="Weakness Policy":
            em.add_field(name=f"{y.icon} {y.nickname}'s {await itemicon(y.item)} {y.item}!",value=f"{y.item} poosted attack and special attack!")
            y.item+="[Used]"
            await atkchange(em,y,x,1)
            await spatkchange(em,y,x,1)
        ...
        if y.ability in ["Solid Rock","Filter","Prism Armor","Permafrost"]:
            em.add_field(name=f"{y.icon} {y.name}'s {y.ability}!",value="Supet effective move was weakened!")
            eff*=0.75
...
async def atkchange(em,x,y,amount):
    ...
    x.atkb+=amount         
    if x.atkb<-6:
        em.add_field(name="<:low:1140755454071418910>Attack Drop:",value=f"{x.icon} {x.nickname}'s attack won't go any lower!")
        x.atkb=-6
    elif x.atkb>6:
        em.add_field(name="<:high:1140755420533772389>Attack Increase:",value=f"{x.icon} {x.nickname}'s attack won't go any higher!")
        x.atkb=6  
    elif x.atkb<=6 and x.name!="Substitute" and x.hp>0 and amount>0:
        if amount==1:
            em.add_field(name="<:high:1140755420533772389>Attack Increase:",value=f"{x.icon} {x.nickname}'s attack rose!")
        elif amount==2:
            em.add_field(name="<:high:1140755420533772389>Attack Increase:",value=f"{x.icon} {x.nickname}'s attack sharply rose!")
        elif amount>=3:
            em.add_field(name="<:high:1140755420533772389>Attack Increase:",value=f"{x.icon} {x.nickname}'s attack drastically rose!")
    elif x.atkb>=-6 and x.name!="Substitute" and x.hp>0:
        if amount==-1:
            em.add_field(name="<:low:1140755454071418910>Attack Drop:",value=f"{x.icon} {x.nickname}'s attack fell!")
        elif amount<=-2:
            em.add_field(name="<:low:1140755454071418910>Attack Drop:",value=f"{x.icon} {x.nickname}'s attack harshly fell!")               
...
async def defchange(em,x,y,amount):
    ...
    x.defb+=amount
    if x.defb<-6:
        em.add_field(name="<:low:1140755454071418910>Defense Drop:",value=f"{x.icon} {x.nickname}'s defense won't go any lower!") 
        x.defb=-6
    if x.defb>6:
        em.add_field(name="<:high:1140755420533772389>Defense Increase:",value=f"{x.icon} {x.nickname}'s defense won't go any higher!")
        x.defb=6  
    elif x.defb<=6 and x.name!="Substitute" and x.hp>0 and amount>0:
        if amount==1:
            em.add_field(name="<:high:1140755420533772389>Defense Increase:",value=f"{x.icon} {x.nickname}'s defense rose!")
        elif amount==2:
            em.add_field(name="<:high:1140755420533772389>Defense Increase:",value=f"{x.icon} {x.nickname}'s defense sharply rose!")
        elif amount>=3:
            em.add_field(name="<:high:1140755420533772389>Defense Increase:",value=f"{x.icon} {x.nickname}'s defense drastically rose!")
    elif x.defb>=-6 and x.name!="Substitute" and x.hp>0:
        if amount==-1:
            em.add_field(name="<:low:1140755454071418910>Defense Drop:",value=f"{x.icon} {x.nickname}'s defense fell!")
        elif amount<=-2:
            em.add_field(name="<:low:1140755454071418910>Defense Drop:",value=f"{x.icon} {x.nickname}'s defense harshly fell!") 
...
async def spatkchange(em,x,y,amount):
    ...
    x.spatkb+=amount
    if x.spatkb<-6:
        em.add_field(name="<:low:1140755454071418910>Special Attack Drop:",value=f"{x.icon} {x.nickname}'s special attack won't go any lower!") 
        x.spatkb=-6
    elif x.spatkb>6:
        em.add_field(name="<:high:1140755420533772389>Special Attack Increase:",value=f"{x.icon} {x.nickname}'s special attack won't go any higher!")
        x.spatkb=6
    elif x.spatkb<=6 and x.name!="Substitute" and x.hp>0 and amount>0:
        if amount==1:
            em.add_field(name="<:high:1140755420533772389>Special Attack Increase:",value=f"{x.icon} {x.nickname}'s special attack rose!")
        elif amount==2:
            em.add_field(name="<:high:1140755420533772389>Special Attack Increase:",value=f"{x.icon} {x.nickname}'s special attack sharply rose!")
        elif amount>=3:
            em.add_field(name="<:high:1140755420533772389>Special Attack Increase:",value=f"{x.icon} {x.nickname}'s special attack drastically rose!")
    elif x.spatkb>=-6 and x.name!="Substitute" and x.hp>0:
        if amount==-1:
            em.add_field(name="<:low:1140755454071418910>Special Attack Drop:",value=f"{x.icon} {x.nickname}'s special attack fell!")
        elif amount<=-2:
            em.add_field(name="<:low:1140755454071418910>Special Attack Drop:",value=f"{x.icon} {x.nickname}'s special attack harshly fell!") 
...
async def spdefchange(em,x,y,amount):
    ...
    x.spdefb+=amount
    if x.spdefb<-6:
        em.add_field(name="<:low:1140755454071418910>Special Defense Drop:",value=f"{x.icon} {x.nickname}'s special defense won't go any lower!")
        x.spdefb=-6
    elif x.spdefb>6:
        em.add_field(name="<:high:1140755420533772389>Special Defense Increase:",value=f"{x.icon} {x.nickname}'s special defense won't go any higher!")
        x.spdefb=6 
    elif x.spdefb<=6 and x.name!="Substitute" and x.hp>0 and amount>0:
        if amount==1:
            em.add_field(name="<:high:1140755420533772389>Special Defense Increase:",value=f"{x.icon} {x.nickname}'s special defense rose!")
        elif amount==2:
            em.add_field(name="<:high:1140755420533772389>Special Defense Increase:",value=f"{x.icon} {x.nickname}'s special defense sharply rose!")
        elif amount>=3:
            em.add_field(name="<:high:1140755420533772389>Special Defense Increase:",value=f"{x.icon} {x.nickname}'s special defense drastically rose!")
    elif x.spdefb>=-6 and x.name!="Substitute" and x.hp>0:
        if amount==-1:
            em.add_field(name="<:low:1140755454071418910>Special Defense Drop:",value=f"{x.icon} {x.nickname}'s special defense fell!")
        elif amount<=-2:
            em.add_field(name="<:low:1140755454071418910>Special Defense Drop:",value=f"{x.icon} {x.nickname}'s special defense harshly fell!") 
...
async def speedchange(em,x,y,amount):
    ...
    x.speedb+=amount
    if x.speedb<-6:
        em.add_field(name="<:low:1140755454071418910>Speed Drop:",value=f"{x.icon} {x.nickname}'s speed won't go any lower!")
        x.speedb=-6
    if x.speedb>6:
        em.add_field(name="<:high:1140755420533772389>Speed Increase:",value=f"{x.icon} {x.nickname}'s speed won't go any higher!")
        x.speedb=6    
    elif x.speedb<=6 and x.name!="Substitute" and x.hp>0 and amount>0:
        if amount==1:
            em.add_field(name="<:high:1140755420533772389>Speed Increase:",value=f"{x.icon} {x.nickname}'s speed rose!")
        elif amount==2:
            em.add_field(name="<:high:1140755420533772389>Speed Increase:",value=f"{x.icon} {x.nickname}'s speed sharply rose!")
        elif amount>=3:
            em.add_field(name="<:high:1140755420533772389>Speed Increase:",value=f"{x.icon} {x.nickname}'s speed drastically rose!")
    elif x.speedb>=-6 and x.name!="Substitute" and x.hp>0:
        if amount==-1:
            em.add_field(name="<:low:1140755454071418910>Speed Drop:",value=f"{x.icon} {x.nickname}'s speed fell!")
        elif amount<=-2:
            em.add_field(name="<:low:1140755454071418910>Speed Drop:",value=f"{x.icon} {x.nickname}'s speed harshly fell!") 